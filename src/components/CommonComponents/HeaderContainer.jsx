...
function HeaderContainer(props) {
  const { token, logOut, headerText, name, isAdmin, resetCoinsSearch, resetAdvancedSearch } = props;
  return (
    <Header token={token} logOut={logOut} headerText={headerText} resetCoinsSearch={resetCoinsSearch} resetAdvancedSearch={resetAdvancedSearch} name={name} isAdmin={isAdmin}/>
  );
}
